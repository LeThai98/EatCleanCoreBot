...
{
    public class ValidateHeight : ComponentDialog
    {
        public ValidateHeight() : base(nameof(ValidateHeight))
        {
        ...
        private async Task<DialogTurnResult> AskHeightAsync(WaterfallStepContext stepContext, CancellationToken cancellationToken)
        {
            ...
            {
                Prompt = MessageFactory.Text("How many mets do you height? Please enter an height greater than 0.")
            }, cancellationToken);
        }
        ...
        private async Task<DialogTurnResult> ConfirmStepAsync(WaterfallStepContext stepContext, CancellationToken cancellationToken)
        {
            ...
            else
            {
                ...
                await stepContext.Context.SendActivityAsync(MessageFactory.Text($"Your height is {weight}mets."), cancellationToken);
